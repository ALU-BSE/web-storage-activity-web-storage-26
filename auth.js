...
function login(username, password) {
  ...
  // HttpOnly is included here to demonstrate awareness of the flag.
  document.cookie = `authToken=user123; expires=${expiryDate.toUTCString()}; Secure; HttpOnly; path=/`;
...
// this function helps to read a specific cookie by name
